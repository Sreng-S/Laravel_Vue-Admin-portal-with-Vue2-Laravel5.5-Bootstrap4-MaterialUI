                ...
                <table class="table table-borderless m-b-none">
                    ...
                    <tbody>
                        <tr v-for="member in team.users">
                            ...
                            <!-- Delete Button -->
                            <td>
                                <button class="btn btn-danger-outline waves-effect"
            ...
            <div class="modal-dialog" v-if="updatingTeamMember">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary waves-effect" @click="update" :disabled="updateTeamMemberForm.busy">
                            Update
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-dialog" v-if="deletingTeamMember">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger waves-effect" @click="deleteMember" :disabled="deleteTeamMemberForm.busy">
                            Yes, Remove
                        </button>
                    </div>
                </div>
