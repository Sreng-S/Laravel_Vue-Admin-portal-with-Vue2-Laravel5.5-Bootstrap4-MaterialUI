                ...
                <table class="table table-borderless m-b-none">
                    ...
                    <tbody>
                        <tr v-for="plan in plansForActiveInterval">
                            ...
                            <td>
                                <button class="btn btn-default m-l-sm waves-effect" @click="showPlanDetails(plan)">
                            ...
                            <!-- Plan Select Button -->
                            <td class="text-right">
                                <button class="btn btn-primary btn-plan waves-effect" v-if="isActivePlan(plan)" disabled>
                                    <i class="fa fa-btn fa-check"></i>Current Plan
                                </button>

                                <button class="btn btn-primary-outline btn-plan waves-effect"
                                ...
                                <button class="btn btn-primary btn-plan waves-effect"
            ...
            <div class="modal-dialog">
                <div class="modal-content" v-if="confirmingPlan">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary waves-effect" @click="approvePlanUpdate">Yes, I'm Sure</button>
                    </div>
                </div>
            </div>
        </div>
