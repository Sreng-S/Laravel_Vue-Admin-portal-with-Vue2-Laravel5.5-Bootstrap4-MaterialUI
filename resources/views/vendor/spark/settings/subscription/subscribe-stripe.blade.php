<spark-subscribe-stripe :user="user" :team="team"
    ...
    <div>
        ...
        <!-- Billing Information -->
        <div class="card" v-show="selectedPlan">
            ...
            <div class="card-block">
                ...
                <!-- Cardholder's Name -->
                    ...
                    <div class="row">
                        <div class="col-md-3"></div>
                        <div class="col-md-6 m-t-5">
                            <div class="form-group-custom" :class="{'has-error': form.errors.has('coupon')}">
                                <input type="text" v-model="form.coupon" required="required"/>
                                <label class="control-label">Coupon</label><i class="bar"></i>
                    ...
                    <div class="form-group">
                        <div class="col-md-12 text-center">
                            <button type="submit" class="btn btn-primary waves-effect" @click.prevent="subscribe" :disabled="form.busy">
                            <span v-if="form.busy">
