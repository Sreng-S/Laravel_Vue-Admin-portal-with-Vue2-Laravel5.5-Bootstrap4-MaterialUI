...
<div class="row">
    ...
    <div class="col-md-6 m-t-5">
        <div class="form-group-custom" :class="{'has-error': form.errors.has('address')}">
...
<div class="row">
    <div class="col-md-3"></div>
    <div class="col-md-6 m-t-5">
        <div class="form-group-custom" :class="{'has-error': form.errors.has('vat_id')}" v-if="countryCollectsVat">
            <input type="text" name="name" v-model="form.vat_id" required="required"/>
            <label class="control-label">VAT ID</label><i class="bar"></i>
        </div>
