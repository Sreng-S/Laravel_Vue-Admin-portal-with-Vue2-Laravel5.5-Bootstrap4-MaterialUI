                    ...
                    <table class="table table-borderless m-b-none">
                        ...
                        <tbody>
                            <tr v-for="token in tokens">
                                ...
                                <!-- Edit Button -->
                                <td>
                                    <button class="btn btn-primary waves-effect" @click="editToken(token)">
                                ...
                                <!-- Delete Button -->
                                <td>
                                    <button class="btn btn-danger-outline waves-effect" @click="approveTokenDelete(token)">
            ...
            <div class="modal-dialog" v-if="updatingToken">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary waves-effect" @click="updateToken" :disabled="updateTokenForm.busy">
                            Update
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-dialog" v-if="deletingToken">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger waves-effect" @click="deleteToken" :disabled="deleteTokenForm.busy">
                            Yes, Delete
                        </button>
                    </div>
                </div>
