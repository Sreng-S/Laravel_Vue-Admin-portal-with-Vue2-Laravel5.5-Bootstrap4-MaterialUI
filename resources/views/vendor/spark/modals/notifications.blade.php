            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <div class="btn-group">
                            <button class="btn btn-default waves-effect" :class="{'active': showingNotifications}" @click="showNotifications" style="width: 50%;">
                                Notifications
                            </button>

                            <button class="btn btn-default waves-effect" :class="{'active': showingAnnouncements}" @click="showAnnouncements" style="width: 50%;">
                        ...
                        <div class="notification-container" v-if="showingNotifications && hasNotifications">
                            <div class="notification" v-for="notification in notifications.notifications">
                                ...
                                <div class="notification-content">
                                    ...
                                    <!-- Notification Action -->
                                    <a :href="notification.action_url" class="btn btn-primary waves-effect" v-if="notification.action_text">
                        ...
                        <div class="notification-container" v-if="showingAnnouncements && hasAnnouncements">
                            <div class="notification" v-for="announcement in notifications.announcements">
                                ...
                                <div class="notification-content">
                                    ...
                                    <!-- Announcement Action -->
                                    <a :href="announcement.action_url" class="btn btn-primary waves-effect" v-if="announcement.action_text">
