<spark-kiosk-users :user="user" inline-template>
    <div>
        <div v-show=" ! showingUserProfile">
            ...
            <!-- No Search Results -->
            <div class="card" v-if=" ! searching && noSearchResults">
                <div class="card-header bg-warning">Search Results</div>
            ...
            <!-- User Search Results -->
            <div class="card" v-if=" ! searching && searchResults.length > 0">
                <div class="card-header">Search Results</div>
